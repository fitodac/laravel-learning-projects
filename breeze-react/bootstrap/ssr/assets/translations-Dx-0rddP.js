const translations = {
  en: {
    ...
    "update-password-description": "Ensure your account is using a long, random password to stay secure.",
  ...
  es: {
    ...
    "confirm-password-message": "Por favor confirma tu contraseña antes de continuar.",
    Confirm: "Confirmar",
    ...
    "email-verify-link": "Haz click aquí para enviar el correo de verificación.",
    ...
    "delete-account-confirmation-title": "¿Estás seguro de querer eliminar tu cuenta?",
    ...
    "update-password-description": "Asegúrate de que tu cuenta utiliza una contraseña larga y aleatoria para mantener la seguridad.",
...
const t = (str) => {
  if (!str) return "";
  const translation = translations.en[str];
